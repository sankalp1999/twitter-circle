...
function processConversations(allData, recipientUserId, recipientUsername, imageSrc, lastMessage, lastMessageDate) {
...
const results = dmStats.map(conv => {
	...
	return processConversations(directMessagesData, recipientId, recipientUsername, imageSrc, lastMessage, lastMessageDate)
})

fs.writeFileSync('dm_chart_stats_dict.json', JSON.stringify(results, null, 2))
